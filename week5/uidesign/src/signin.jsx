...
function Signinpage(){
    ...
    <div class= " p-20 min-h-screen flex flex-col items-center justify-items-center">
        <div class='flex flex-col justify-center items-center'>
            ...
            <p class=" pb-5 text-lg font-bold text-gray-500">SignIn</p>
       </div>
    ...
    <div class=" p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        }} type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign In</button>
        </form>
        </div>
    </div>
    </div>
